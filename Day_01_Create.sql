...
Bir veritabanında 'musteriler' adında yeni bir tablo oluşturun. Bu tablonun aşağıdaki sütunları içermesi gerekmektedir:
...
Yukarıda oluşturduğunuz 'musteriler' tablosunu kullanarak, sadece isim ve email sütunlarını içeren 'iletisim_bilgileri' adında yeni bir tablo oluşturun. Bu yeni tablonun ayrıca 'id' adında bir sütunu olmalıdır.
...
CREATE TABLE iletisim_bilgileri AS SELECT isim, email FROM musteriler;
...
INSERT INTO iletisim_bilgileri2 (isim, email) SELECT isim, email FROM musteriler;
